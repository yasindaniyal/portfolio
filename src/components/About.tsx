      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          <p className="text-lg text-gray-300 leading-relaxed">
            I'm a passionate Frontend Developer specializing in the MERN stack
            with expertise in creating pixel-perfect user interfaces. As a fresh
            Software Engineering graduate, I bring modern development practices
            and a keen eye for detail to every project.
          </p>
          <p className="text-lg text-gray-300 leading-relaxed">
            My experience spans from responsive web development to full-stack
            applications, with a focus on clean code, scalable architectures,
            and exceptional user experiences. I'm passionate about staying
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex items-center gap-2 text-purple-400">
              ...
              <span>
                <strong>Frontend & MERN Stack Specialist</strong>
              </span>
            </div>
          </div>
        </div>
